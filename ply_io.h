...
typedef struct PlyProperty {    /* description of a property */
  ...
  int is_list;                  /* 0 = scalar, 1 = list, 2 = char string, 3 = fixed length list */
  int count_external;           /* file's count type */
  int count_internal;           /* program's count type */
  int count_offset;             /* offset byte for list count OR size of the fixed length list */
